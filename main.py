...
.h button{background:#e74c3c;border:none;color:#fff;padding:8px 18px;border-radius:6px;cursor:pointer}
.t{display:flex;gap:5px;margin-bottom:20px}
.tb{padding:10px 20px;background:#16213e;border:none;color:#aaa;cursor:pointer;border-radius:8px 8px 0 0}
.tb.ac{background:#7c5cfc;color:#fff}
.pn{display:none;background:#16213e;padding:25px;border-radius:0 12px 12px 12px;margin-bottom:20px}
.pn.ac{display:block}
...
.bok{background:rgba(39,174,96,0.3);color:#2ecc71}.ber{background:rgba(231,76,60,0.3);color:#e74c3c}
.to{position:fixed;bottom:20px;right:20px;padding:15px 25px;border-radius:8px;color:#fff;display:none;z-index:99}
